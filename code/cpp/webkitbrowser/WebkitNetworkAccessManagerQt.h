#ifndef WEBKITNETWORKACCESSMANAGERQT_H
#define WEBKITNETWORKACCESSMANAGERQT_H
...
class WebkitNetworkAccessManagerQt : public QNetworkAccessManager
{
    Q_OBJECT
...
//    WebkitNetworkAccessManagerQt(QNetworkAccessManager *manager, const OkToLoadUrlFunT& okToLoadUrlFun, QObject *parent);
    WebkitNetworkAccessManagerQt(
    ...
    int requestStartCount                   () const;
    int requestFinishedCount                () const;
...
#endif // WEBKITNETWORKACCESSMANAGERQT_H
