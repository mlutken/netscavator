...
private:
    ...
    {
        printf("wxSizeReportCtrl::OnPaint\n");
        wxPaintDC dc(this);
    ...
    {
        //printf("wxSizeReportCtrl::OnSize\n");
        Refresh();
    }
private:
...
//    m_mgr.AddPane(CreateNotebook(), wxAuiPaneInfo().Name(wxT("xxxxxxxxxxxxxxx")).
 //                 CenterPane().PaneBorder(false));
...
wxAuiNotebook* MyFrame::CreateNotebook()
{
   ...
   ctrl->AddPage( panel, wxT("wxPanel"), false, page_bmp );
	...
	TestCreatorBrowserControl* pBrowserControl = new TestCreatorBrowserControl( ctrl );
   ...
   ctrl->AddPage(pBrowserControl, wxT("Browser") , false, page_bmp);

   ctrl->AddPage(CreateSizeReportCtrl(12,30), wxT("SizeControl") , false, page_bmp);
