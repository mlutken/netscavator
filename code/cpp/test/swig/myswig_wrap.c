...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(myswig)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(myswig)
ZEND_DECLARE_MODULE_GLOBALS(myswig)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(myswig_globals_id, zend_myswig_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(myswig_globals_id, zend_myswig_globals *, error_code )
#else
#define SWIG_ErrorMsg() (myswig_globals.error_msg)
#define SWIG_ErrorCode() (myswig_globals.error_code)
#endif

static void myswig_init_globals(zend_myswig_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void myswig_destroy_globals(zend_myswig_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_Swig_variable_set) {
  ...
  /*@SWIG:/usr/share/swig/1.3.35/php4/utils.i,16,CONVERT_FLOAT_IN@*/
...
static zend_function_entry myswig_functions[] = {
 SWIG_ZEND_NAMED_FE(swig_variable_set,_wrap_Swig_variable_set,NULL)
 SWIG_ZEND_NAMED_FE(swig_variable_get,_wrap_Swig_variable_get,NULL)
 SWIG_ZEND_NAMED_FE(swig_fact,_wrap_Swig_fact,NULL)
 SWIG_ZEND_NAMED_FE(swig_div,_wrap_Swig_div,NULL)
{NULL, NULL, NULL}
};

/* init section */
zend_module_entry myswig_module_entry = {
    ...
    myswig_functions,
    PHP_MINIT(myswig),
    PHP_MSHUTDOWN(myswig),
    PHP_RINIT(myswig),
    PHP_RSHUTDOWN(myswig),
    PHP_MINFO(myswig),
#if ZEND_MODULE_API_NO > 20010900
    NO_VERSION_YET,
#endif
...
zend_module_entry* SWIG_module_entry = &myswig_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &myswig_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(myswig)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(myswig, myswig_init_globals, myswig_destroy_globals);
...
/* vinit subsection */
{
  ...
  z_var->value.dval = Swig_variable;
  zend_hash_add(&EG(symbol_table), (char*)"Swig_variable", sizeof("Swig_variable"), (void *)&z_var,
  sizeof(zval *), NULL);
}
