...
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(myclass_globals_id, zend_myclass_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(myclass_globals_id, zend_myclass_globals *, error_code )
#else
#define SWIG_ErrorMsg() (myclass_globals.error_msg)
#define SWIG_ErrorCode() (myclass_globals.error_code)
#endif

static void myclass_init_globals(zend_myclass_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void myclass_destroy_globals(zend_myclass_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_Vector_magnitude2) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Vector, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Vector_magnitude2. Expected SWIGTYPE_p_Vector");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  result = (double)(arg1)->magnitude2();
  {
    ZVAL_DOUBLE(return_value,result);
  }
  return;
...
//      else
//      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of callMemberCallback. Expected SWIGTYPE_p_p_void");
    }
  }
  ...
  callMemberCallback(arg1,(char const *)arg2);
...
static zend_function_entry myclass_functions[] = {
 ...
 SWIG_ZEND_NAMED_FE(vector_magnitude2,_wrap_Vector_magnitude2,NULL)
 SWIG_ZEND_NAMED_FE(callcallback,_wrap_callCallback,NULL)
 SWIG_ZEND_NAMED_FE(callmembercallback,_wrap_callMemberCallback,NULL)
{NULL, NULL, NULL}
};
...
zend_module_entry* SWIG_module_entry = &myclass_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &myclass_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(myclass)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(myclass, myclass_init_globals, myclass_destroy_globals);
