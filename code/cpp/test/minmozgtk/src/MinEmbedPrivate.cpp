...
#include "MinEmbedProgress.h"
#include "MinEmbedContentListener.h"
#include "MinEmbedEventListener.h"
#include "MinEmbedWindowCreator.h"
#include "MinGtkPromptService.h"
...
nsresult
EmbedPrivate::Init(MinGtkMozEmbed *aOwningWidget)
{
