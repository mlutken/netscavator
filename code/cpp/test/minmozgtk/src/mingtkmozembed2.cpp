...
#include "MinEmbedPrivate.h"
#include "MinEmbedWindow.h"

// so we can do our get_nsIWebBrowser later...
#include "nsIWebBrowser.h"

#include "mingtkmozembedmarshal.h"
...
static void
gtk_moz_embed_class_init ( MinGtkMozEmbedClass *klass );

static void
gtk_moz_embed_init ( MinGtkMozEmbed *embed );
...
gtk_moz_embed_get_type ( void )
{
	...
	if ( moz_embed_type == 0 )
	{
		...
		{
			sizeof ( MinGtkMozEmbedClass ),
			NULL, /* base_init */
			NULL, /* base_finalize */
			( GClassInitFunc ) gtk_moz_embed_class_init,
			NULL,
			NULL, /* class_data */
			sizeof ( MinGtkMozEmbed ),
			0, /* n_preallocs */
...
gtk_moz_embed_class_init ( MinGtkMozEmbedClass *klass )
{
	printf ( "MinMoz: gtk_moz_embed_class_init\n" ) ;
	printf ( "MinMoz: gtk_moz_embed_class_init\n" ) ;
	printf ( "MinMoz: gtk_moz_embed_class_init\n" ) ;
	printf ( "MinMoz: gtk_moz_embed_class_init\n" ) ;
	printf ( "MinMoz: gtk_moz_embed_class_init\n" ) ;
	...
	moz_embed_signals[LINK_MESSAGE] =
		g_signal_new ( "link_message",
					   ...
					   G_SIGNAL_RUN_FIRST,
					   G_STRUCT_OFFSET ( MinGtkMozEmbedClass, link_message ),
					   NULL, NULL,
	...
	moz_embed_signals[JS_STATUS] =
		g_signal_new ( "js_status",
					   G_TYPE_FROM_CLASS ( klass ),
					   G_SIGNAL_RUN_FIRST,
					   G_STRUCT_OFFSET ( MinGtkMozEmbedClass, js_status ),
					   NULL, NULL,
					   gtk_marshal_NONE__NONE,
					   G_TYPE_NONE, 0 );
	moz_embed_signals[LOCATION] =
		g_signal_new ( "location",
					   G_TYPE_FROM_CLASS ( klass ),
					   G_SIGNAL_RUN_FIRST,
					   G_STRUCT_OFFSET ( MinGtkMozEmbedClass, location ),
					   NULL, NULL,
					   gtk_marshal_NONE__NONE,
					   G_TYPE_NONE, 0 );
	moz_embed_signals[TITLE] =
		g_signal_new ( "title",
					   G_TYPE_FROM_CLASS ( klass ),
					   G_SIGNAL_RUN_FIRST,
					   G_STRUCT_OFFSET ( MinGtkMozEmbedClass, title ),
					   NULL, NULL,
					   gtk_marshal_NONE__NONE,
					   G_TYPE_NONE, 0 );
	moz_embed_signals[PROGRESS] =
		g_signal_new ( "progress",
					   G_TYPE_FROM_CLASS ( klass ),
					   G_SIGNAL_RUN_FIRST,
					   G_STRUCT_OFFSET ( MinGtkMozEmbedClass, progress ),
					   NULL, NULL,
	...
	moz_embed_signals[PROGRESS_ALL] =
		g_signal_new ( "progress_all",
					   G_TYPE_FROM_CLASS ( klass ),
					   G_SIGNAL_RUN_FIRST,
					   G_STRUCT_OFFSET ( MinGtkMozEmbedClass, progress_all ),
					   NULL, NULL,
	...
	moz_embed_signals[NET_STATE] =
		g_signal_new ( "net_state",
					   G_TYPE_FROM_CLASS ( klass ),
					   G_SIGNAL_RUN_FIRST,
					   G_STRUCT_OFFSET ( MinGtkMozEmbedClass, net_state ),
					   NULL, NULL,
	...
	moz_embed_signals[NET_STATE_ALL] =
		g_signal_new ( "net_state_all",
					   G_TYPE_FROM_CLASS ( klass ),
					   G_SIGNAL_RUN_FIRST,
					   G_STRUCT_OFFSET ( MinGtkMozEmbedClass, net_state_all ),
					   NULL, NULL,
	...
	moz_embed_signals[NET_START] =
		g_signal_new ( "net_start",
					   G_TYPE_FROM_CLASS ( klass ),
					   G_SIGNAL_RUN_FIRST,
					   G_STRUCT_OFFSET ( MinGtkMozEmbedClass, net_start ),
					   NULL, NULL,
					   gtk_marshal_NONE__NONE,
					   G_TYPE_NONE, 0 );
	moz_embed_signals[NET_STOP] =
		g_signal_new ( "net_stop",
					   G_TYPE_FROM_CLASS ( klass ),
					   G_SIGNAL_RUN_FIRST,
					   G_STRUCT_OFFSET ( MinGtkMozEmbedClass, net_stop ),
					   NULL, NULL,
					   gtk_marshal_NONE__NONE,
					   G_TYPE_NONE, 0 );
	moz_embed_signals[NEW_WINDOW] =
		g_signal_new ( "new_window",
					   G_TYPE_FROM_CLASS ( klass ),
					   G_SIGNAL_RUN_FIRST,
					   G_STRUCT_OFFSET ( MinGtkMozEmbedClass, new_window ),
					   NULL, NULL,
	...
	moz_embed_signals[VISIBILITY] =
		g_signal_new ( "visibility",
					   G_TYPE_FROM_CLASS ( klass ),
					   G_SIGNAL_RUN_FIRST,
					   G_STRUCT_OFFSET ( MinGtkMozEmbedClass, visibility ),
					   NULL, NULL,
	...
	moz_embed_signals[DESTROY_BROWSER] =
		g_signal_new ( "destroy_browser",
					   G_TYPE_FROM_CLASS ( klass ),
					   G_SIGNAL_RUN_FIRST,
					   G_STRUCT_OFFSET ( MinGtkMozEmbedClass, destroy_brsr ),
					   NULL, NULL,
					   gtk_marshal_NONE__NONE,
					   G_TYPE_NONE, 0 );
	moz_embed_signals[OPEN_URI] =
		g_signal_new ( "open_uri",
					   G_TYPE_FROM_CLASS ( klass ),
					   G_SIGNAL_RUN_LAST,
					   G_STRUCT_OFFSET ( MinGtkMozEmbedClass, open_uri ),
					   NULL, NULL,
	...
	moz_embed_signals[SIZE_TO] =
		g_signal_new ( "size_to",
					   G_TYPE_FROM_CLASS ( klass ),
					   G_SIGNAL_RUN_LAST,
					   G_STRUCT_OFFSET ( MinGtkMozEmbedClass, size_to ),
					   NULL, NULL,
					   gtk_marshal_NONE__INT_INT,
					   G_TYPE_NONE, 2, G_TYPE_INT, G_TYPE_INT );
	moz_embed_signals[DOM_KEY_DOWN] =
		g_signal_new ( "dom_key_down",
					   G_TYPE_FROM_CLASS ( klass ),
					   G_SIGNAL_RUN_LAST,
					   G_STRUCT_OFFSET ( MinGtkMozEmbedClass, dom_key_down ),
					   NULL, NULL,
	...
	moz_embed_signals[DOM_KEY_PRESS] =
		g_signal_new ( "dom_key_press",
					   G_TYPE_FROM_CLASS ( klass ),
					   G_SIGNAL_RUN_LAST,
					   G_STRUCT_OFFSET ( MinGtkMozEmbedClass, dom_key_press ),
					   NULL, NULL,
					   gtk_marshal_BOOL__POINTER,
					   G_TYPE_BOOLEAN, 1, G_TYPE_POINTER );
	moz_embed_signals[DOM_KEY_UP] =
		g_signal_new ( "dom_key_up",
					   G_TYPE_FROM_CLASS ( klass ),
					   G_SIGNAL_RUN_LAST,
					   G_STRUCT_OFFSET ( MinGtkMozEmbedClass, dom_key_up ),
					   NULL, NULL,
					   gtk_marshal_BOOL__POINTER,
					   G_TYPE_BOOLEAN, 1, G_TYPE_POINTER );
	moz_embed_signals[DOM_MOUSE_DOWN] =
		g_signal_new ( "dom_mouse_down",
					   G_TYPE_FROM_CLASS ( klass ),
					   G_SIGNAL_RUN_LAST,
					   G_STRUCT_OFFSET ( MinGtkMozEmbedClass, dom_mouse_down ),
					   NULL, NULL,
					   gtk_marshal_BOOL__POINTER,
					   G_TYPE_BOOLEAN, 1, G_TYPE_POINTER );
	moz_embed_signals[DOM_MOUSE_UP] =
		g_signal_new ( "dom_mouse_up",
					   G_TYPE_FROM_CLASS ( klass ),
					   G_SIGNAL_RUN_LAST,
					   G_STRUCT_OFFSET ( MinGtkMozEmbedClass, dom_mouse_up ),
					   NULL, NULL,
					   gtk_marshal_BOOL__POINTER,
					   G_TYPE_BOOLEAN, 1, G_TYPE_POINTER );
	moz_embed_signals[DOM_MOUSE_CLICK] =
		g_signal_new ( "dom_mouse_click",
					   G_TYPE_FROM_CLASS ( klass ),
					   G_SIGNAL_RUN_LAST,
					   G_STRUCT_OFFSET ( MinGtkMozEmbedClass, dom_mouse_click ),
					   NULL, NULL,
					   gtk_marshal_BOOL__POINTER,
					   G_TYPE_BOOLEAN, 1, G_TYPE_POINTER );
	moz_embed_signals[DOM_MOUSE_DBL_CLICK] =
		g_signal_new ( "dom_mouse_dbl_click",
					   G_TYPE_FROM_CLASS ( klass ),
					   G_SIGNAL_RUN_LAST,
					   G_STRUCT_OFFSET ( MinGtkMozEmbedClass, dom_mouse_dbl_click ),
					   NULL, NULL,
					   gtk_marshal_BOOL__POINTER,
					   G_TYPE_BOOLEAN, 1, G_TYPE_POINTER );
	moz_embed_signals[DOM_MOUSE_OVER] =
		g_signal_new ( "dom_mouse_over",
					   G_TYPE_FROM_CLASS ( klass ),
					   G_SIGNAL_RUN_LAST,
					   G_STRUCT_OFFSET ( MinGtkMozEmbedClass, dom_mouse_over ),
					   NULL, NULL,
					   gtk_marshal_BOOL__POINTER,
					   G_TYPE_BOOLEAN, 1, G_TYPE_POINTER );
	moz_embed_signals[DOM_MOUSE_OUT] =
		g_signal_new ( "dom_mouse_out",
					   G_TYPE_FROM_CLASS ( klass ),
					   G_SIGNAL_RUN_LAST,
					   G_STRUCT_OFFSET ( MinGtkMozEmbedClass, dom_mouse_out ),
					   NULL, NULL,
					   gtk_marshal_BOOL__POINTER,
					   G_TYPE_BOOLEAN, 1, G_TYPE_POINTER );
	moz_embed_signals[SECURITY_CHANGE] =
		g_signal_new ( "security_change",
					   G_TYPE_FROM_CLASS ( klass ),
					   G_SIGNAL_RUN_LAST,
					   G_STRUCT_OFFSET ( MinGtkMozEmbedClass, security_change ),
					   NULL, NULL,
					   gtk_marshal_NONE__POINTER_UINT,
					   G_TYPE_NONE, 2, G_TYPE_POINTER, G_TYPE_UINT );
	moz_embed_signals[STATUS_CHANGE] =
		g_signal_new ( "status_change",
					   G_TYPE_FROM_CLASS ( klass ),
					   G_SIGNAL_RUN_LAST,
					   G_STRUCT_OFFSET ( MinGtkMozEmbedClass, status_change ),
					   NULL, NULL,
	...
	moz_embed_signals[DOM_ACTIVATE] =
		g_signal_new ( "dom_activate",
					   G_TYPE_FROM_CLASS ( klass ),
					   G_SIGNAL_RUN_LAST,
					   G_STRUCT_OFFSET ( MinGtkMozEmbedClass, dom_activate ),
					   NULL, NULL,
					   gtk_marshal_BOOL__POINTER,
					   G_TYPE_BOOLEAN, 1, G_TYPE_POINTER );
	moz_embed_signals[DOM_FOCUS_IN] =
		g_signal_new ( "dom_focus_in",
					   G_TYPE_FROM_CLASS ( klass ),
					   G_SIGNAL_RUN_LAST,
					   G_STRUCT_OFFSET ( MinGtkMozEmbedClass, dom_focus_in ),
					   NULL, NULL,
					   gtk_marshal_BOOL__POINTER,
					   G_TYPE_BOOLEAN, 1, G_TYPE_POINTER );
	moz_embed_signals[DOM_FOCUS_OUT] =
		g_signal_new ( "dom_focus_out",
					   G_TYPE_FROM_CLASS ( klass ),
					   G_SIGNAL_RUN_LAST,
					   G_STRUCT_OFFSET ( MinGtkMozEmbedClass, dom_focus_out ),
					   NULL, NULL,
					   gtk_marshal_BOOL__POINTER,
					   G_TYPE_BOOLEAN, 1, G_TYPE_POINTER );
}
...
{
	return GTK_WIDGET ( g_object_new ( MINGTK_TYPE_MOZ_EMBED, NULL ) );
}
...
gtk_moz_embed_destroy ( GtkObject *object )
{
	MinGtkMozEmbed  *embed;
	EmbedPrivate *embedPrivate;

	g_return_if_fail ( object != NULL );
	g_return_if_fail ( MINGTK_IS_MOZ_EMBED ( object ) );

	embed = MINGTK_MOZ_EMBED ( object );
...
gtk_moz_embed_realize ( GtkWidget *widget )
{
	...
	g_return_if_fail ( MINGTK_IS_MOZ_EMBED ( widget ) );

	embed = MINGTK_MOZ_EMBED ( widget );
	embedPrivate = ( EmbedPrivate * ) embed->data;
...
gtk_moz_embed_get_accessible ( GtkWidget *widget )
{
	...
	g_return_val_if_fail ( MINGTK_IS_MOZ_EMBED ( widget ), NULL );

	MinGtkMozEmbed  *embed = MINGTK_MOZ_EMBED ( widget );;
...
void
mingtk_moz_embed_set_app_components ( const nsModuleComponentInfo* aComps,
								   int aNumComponents )
{
...
void
mingtk_moz_embed_set_directory_service_provider ( nsIDirectoryServiceProvider *appFileLocProvider )
{
	EmbedPrivate::SetDirectoryServiceProvider ( appFileLocProvider );
}

void
gtk_moz_embed_load_url ( MinGtkMozEmbed *embed, const char *url )
{
	EmbedPrivate *embedPrivate;

	g_return_if_fail ( embed != NULL );
	g_return_if_fail ( MINGTK_IS_MOZ_EMBED ( embed ) );
...
void
gtk_moz_embed_stop_load ( MinGtkMozEmbed *embed )
{
	EmbedPrivate *embedPrivate;
...
gboolean
gtk_moz_embed_can_go_back ( MinGtkMozEmbed *embed )
{
	PRBool retval = PR_FALSE;
	EmbedPrivate *embedPrivate;

	g_return_val_if_fail ( ( embed != NULL ), FALSE );
	g_return_val_if_fail ( MINGTK_IS_MOZ_EMBED ( embed ), FALSE );
...
gboolean
gtk_moz_embed_can_go_forward ( MinGtkMozEmbed *embed )
{
	PRBool retval = PR_FALSE;
	EmbedPrivate *embedPrivate;
...
void
gtk_moz_embed_go_back ( MinGtkMozEmbed *embed )
{
	EmbedPrivate *embedPrivate;
...
void
gtk_moz_embed_go_forward ( MinGtkMozEmbed *embed )
{
	EmbedPrivate *embedPrivate;
...
void
gtk_moz_embed_render_data ( MinGtkMozEmbed *embed, const char *data,
...
void
gtk_moz_embed_open_stream ( MinGtkMozEmbed *embed, const char *base_uri,
							const char *mime_type )
{
	EmbedPrivate *embedPrivate;
...
void gtk_moz_embed_append_data ( MinGtkMozEmbed *embed, const char *data,
								 guint32 len )
{
	EmbedPrivate *embedPrivate;
...
void
gtk_moz_embed_close_stream ( MinGtkMozEmbed *embed )
{
	EmbedPrivate *embedPrivate;
...
char *
gtk_moz_embed_get_link_message ( MinGtkMozEmbed *embed )
{
	char *retval = nsnull;
	EmbedPrivate *embedPrivate;

	g_return_val_if_fail ( ( embed != NULL ), ( char * ) NULL );
	g_return_val_if_fail ( MINGTK_IS_MOZ_EMBED ( embed ), ( char * ) NULL );
...
char *
gtk_moz_embed_get_js_status ( MinGtkMozEmbed *embed )
{
	char *retval = nsnull;
	EmbedPrivate *embedPrivate;
...
char *
gtk_moz_embed_get_title ( MinGtkMozEmbed *embed )
{
	char *retval = nsnull;
	EmbedPrivate *embedPrivate;
...
char *
gtk_moz_embed_get_location ( MinGtkMozEmbed *embed )
{
	char *retval = nsnull;
	EmbedPrivate *embedPrivate;
...
void
gtk_moz_embed_reload ( MinGtkMozEmbed *embed, gint32 flags )
{
	EmbedPrivate *embedPrivate;
	...
	switch ( flags )
	{
	case MINMINGTK_MOZ_EMBED_FLAG_RELOADNORMAL:
		reloadFlags = 0;
		break;
	case MINMINGTK_MOZ_EMBED_FLAG_RELOADBYPASSCACHE:
		reloadFlags = nsIWebNavigation::LOAD_FLAGS_BYPASS_CACHE;
		break;
	case MINMINGTK_MOZ_EMBED_FLAG_RELOADBYPASSPROXY:
		reloadFlags = nsIWebNavigation::LOAD_FLAGS_BYPASS_PROXY;
		break;
	case MINMINGTK_MOZ_EMBED_FLAG_RELOADBYPASSPROXYANDCACHE:
		reloadFlags = ( nsIWebNavigation::LOAD_FLAGS_BYPASS_PROXY |
						nsIWebNavigation::LOAD_FLAGS_BYPASS_CACHE );
		break;
	case MINMINGTK_MOZ_EMBED_FLAG_RELOADCHARSETCHANGE:
...
void
gtk_moz_embed_set_chrome_mask ( MinGtkMozEmbed *embed, guint32 flags )
{
	EmbedPrivate *embedPrivate;
...
guint32
gtk_moz_embed_get_chrome_mask ( MinGtkMozEmbed *embed )
{
	EmbedPrivate *embedPrivate;

	g_return_val_if_fail ( ( embed != NULL ), 0 );
	g_return_val_if_fail ( MINGTK_IS_MOZ_EMBED ( embed ), 0 );
...
void
mingtk_moz_embed_get_nsIWebBrowser ( MinGtkMozEmbed *embed, nsIWebBrowser **retval )
{
	EmbedPrivate *embedPrivate;
...
PRUnichar *
mingtk_moz_embed_get_title_unichar ( MinGtkMozEmbed *embed )
{
	PRUnichar *retval = nsnull;
	EmbedPrivate *embedPrivate;

	g_return_val_if_fail ( ( embed != NULL ), ( PRUnichar * ) NULL );
	g_return_val_if_fail ( MINGTK_IS_MOZ_EMBED ( embed ), ( PRUnichar * ) NULL );
...
PRUnichar *
mingtk_moz_embed_get_js_status_unichar ( MinGtkMozEmbed *embed )
{
	PRUnichar *retval = nsnull;
	EmbedPrivate *embedPrivate;
...
PRUnichar *
mingtk_moz_embed_get_link_message_unichar ( MinGtkMozEmbed *embed )
{
	PRUnichar *retval = nsnull;
	EmbedPrivate *embedPrivate;
...
static void
gtk_moz_embed_single_class_init ( MinMinGtkMozEmbedSingleClass *klass );

static void
gtk_moz_embed_single_init ( MinMinGtkMozEmbedSingle *embed );

MinMinGtkMozEmbedSingle *
...
gtk_moz_embed_single_class_init ( MinMinGtkMozEmbedSingleClass *klass )
{
	...
	moz_embed_single_signals[NEW_WINDOW_ORPHAN] =
		g_signal_new ( "new_window_orphan",
					   G_TYPE_FROM_CLASS ( klass ),
					   G_SIGNAL_RUN_FIRST,
					   G_STRUCT_OFFSET ( MinMinGtkMozEmbedSingleClass, new_window_orphan ),
					   NULL, NULL,
					   gtk_marshal_NONE__POINTER_UINT,
					   G_TYPE_NONE, 2, G_TYPE_POINTER, G_TYPE_UINT );
...
gtk_moz_embed_single_new ( void )
{
	return ( MinMinGtkMozEmbedSingle * ) g_object_new ( MINGTK_TYPE_MOZ_EMBED_SINGLE, NULL );
}

MinMinGtkMozEmbedSingle *
gtk_moz_embed_single_get ( void )
{
	static MinMinGtkMozEmbedSingle *singleton_object = nsnull;
	if ( !singleton_object )
	{
...
void
gtk_moz_embed_single_create_window ( MinGtkMozEmbed **aNewEmbed,
									 guint         aChromeFlags )
{
	MinMinGtkMozEmbedSingle *single = gtk_moz_embed_single_get();
