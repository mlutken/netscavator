#ifndef _WEBBROWSE_SCRIPT_CONTEXT_H_
#define _WEBBROWSE_SCRIPT_CONTEXT_H_
 ...
 * language neutral</I>
 */
class ScriptContext : public Supports {
	MOZ_CONSTRUCT(ScriptContext,Supports);
public:
...
//  virtual void ReportPendingException() = 0;
	...
	// ------------------------------------------------
	bool evaluateString( const std::string& sScript, std::string& sScriptReturnValue );


};

#endif // _WEBBROWSE_SCRIPT_CONTEXT_H_
